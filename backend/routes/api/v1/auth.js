...
router.post('/reset-password', [morgan("combined")], validateUser.resetPassword, AuthController.resetPassword)
router.get('/reset-password/:token', [morgan("combined")], AuthController.getResetPassword)
