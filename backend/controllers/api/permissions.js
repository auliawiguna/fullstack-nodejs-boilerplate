 ...
 */
 export default class PermissionController {
     ...
     */
     show = async (req, res) => {
        let { id } = req.params
        const record = await permissionModel.findByPk(id)
     ...
     */
     store = async (req, res) => {
        let body = req.body
        let save = await permissionModel.create(body)
     ...
     */
     update = async (req, res) => {
        ...
        try {
            ...
            let save = await permissionModel.update(body, {
                where: {
                    'id': id
                }
            })
     ...
     */
     destroy = async (req, res) => {
        try {
            ...
            const deleteRecord = await permissionModel.destroy({
                where : {
                    'id' : id
                }
            })        
